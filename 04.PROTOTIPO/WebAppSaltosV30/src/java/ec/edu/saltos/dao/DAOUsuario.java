...
public class DAOUsuario extends DAOGenerico<Usuario, Integer>{
    ...
    public Usuario autenticar(String _username,String _password) {
        Usuario a = null;
        Session sesion = null;
        Transaction t=null;
        try {
            ...
            String hql = "FROM Usuario where claveusu='"+_password+"' and nombreusuario='"+_username+"'";
            a = (Usuario)sesion.createQuery(hql).uniqueResult();
            t.commit();
