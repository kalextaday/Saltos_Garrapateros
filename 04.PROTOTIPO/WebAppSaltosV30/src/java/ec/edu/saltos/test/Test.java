...
public class Test {
    public static void main(String[] args){
        ...
        usuarioNuevo.setNombreusuario("kataday");
        usuarioNuevo.setClaveusu("12345");
        
        
        if(daousuario.guardar(usuarioNuevo)){
        ...
        listaUsuarios=daousuario.obtenerUsuarios();
        listaUsuarios.forEach((a) -> {
            System.out.println(a.getNombreusuario()+"-empleado:"+a.getEmpleado().getIdEmpleado()+"-perfil:"+a.getPerfil().getIdPerfil());
        });
        ...
        listaAeronaves.forEach((a) -> {
            System.out.println(a.getNombreaer());
        });
