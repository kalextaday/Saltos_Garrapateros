...
import ec.edu.saltos.controlador.app.*;
...
@ManagedBean
@ViewScoped
public class BeanConfigClave implements Serializable{
    ...
    public void modificarClave() {
        DAOConfigClave dao=new DAOConfigClave();
        configClave.setClaveFechaMod(FechaUtil.obtenerFechaActualSinFormato());
        try{
