...
public class Bitacora  implements java.io.Serializable {
     ...
     private String bitRecursoAfectado;
    ...
    public Bitacora(UsuarioAcceso usuarioAcceso, Date bitFecha, String bitOperacion, String bitRecursoAfectado, String bitDescripcion, String bitIp, String bitSo, String bitNavegador) {
       this.usuarioAcceso = usuarioAcceso;
       this.bitFecha = bitFecha;
       this.bitOperacion = bitOperacion;
       this.bitRecursoAfectado = bitRecursoAfectado;
    ...
    public String getBitRecursoAfectado() {
        return this.bitRecursoAfectado;
    }
    
    public void setBitRecursoAfectado(String bitRecursoAfectado) {
        this.bitRecursoAfectado = bitRecursoAfectado;
    }
