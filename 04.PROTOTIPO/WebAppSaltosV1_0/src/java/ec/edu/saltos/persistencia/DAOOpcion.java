...
public class DAOOpcion extends DAOGenerico<Opcion, Integer>{
    ...
    public Opcion obtenerOrigen() {
        ...
        try {
            ...
            String hql = "FROM Opcion where opc_estatus='"+EstadosConfig.OPCION_ORIGEN.getCodigo()+"'";
    ...
    public Opcion obtenerOpcionesSudo(Integer _id,Integer _idPadre) {
        Opcion a = null;
        Session sesion = null;
        Transaction t=null;
        try {
    ...
    public Opcion obtenerOpc(int _idPadre) {
        Opcion a = null;
        Session sesion = null;
        Transaction t=null;
        try {
